...
func _ready() -> void:
	...
	if !SaveLoad.save_content[id].get("was_opened"):
...
func new_save_button_pressed() -> void:
	...
	SaveLoad.save_content[id]["was_opened"] = false
	SaveLoad.save_content[Global.current_save]["current_weapon"] = 1
	SaveLoad.save_content[Global.current_save]["last_saved_pos"] = Vector3(0,0,-26)
	SaveLoad.save_content[Global.current_save]["npc_manager"] = Global.reset_npc_manager
	SaveLoad.save_content[Global.current_save]["cutscenes"] = Global.reset_cutscenes
	SaveLoad.save_content[Global.current_save]["inventory"] = Global.reset_inventory
	...
	SaveLoad.save_content[id]["completed_levels"] = Global.reset_completed_levels
	SaveLoad.save_content[id]["time_lapsed"] = Global.time_lapsed
